...
contract DemaxConfig is TokenRegistry {
    ...
    constructor()  public {
        _initConfig(ConfigNames.PRODUCE_DGAS_RATE, 1 * DGAS_DECIMAL, 120 * DGAS_DECIMAL, 10 * DGAS_DECIMAL, 20 * DGAS_DECIMAL);
        ...
        _initConfig(ConfigNames.UNSTAKE_DURATION, 28800, 28800*7, 28800, 28800);
        _initConfig(ConfigNames.REMOVE_LIQUIDITY_DURATION, 0, 28800*7, 28800, 0);
        ...
        _initConfig(ConfigNames.VOTE_DURATION, 28800, 28800*7, 28800, 28800);
        ...
        _initConfig(ConfigNames.TOKEN_PENGDING_TIME, 0, 100*28800, 10*28800, 100*28800);
